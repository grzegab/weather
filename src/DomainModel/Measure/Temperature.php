...
/**
 * Save temperature measurement for date and location.
 * @package App\DomainModel\Measure
 * @ORM\Entity()
 * @ORM\Table(name="temperature")
 */
class Temperature implements MeasureInterface
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="temperature_seq", initialValue=1)
